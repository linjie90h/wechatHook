...
@interface CMessageWrap : NSObject <NSCopying>
{
    _Bool m_bIsSplit;
    _Bool m_bNew;
    ...
    id m_extendInfoWithMsgTypeForBiz;
    id  m_extendInfoWithMsgType;
    id  m_extendInfoWithFromUsr;
    ...
    unsigned long long _macMsgSourceType;
}
...
@property(retain, nonatomic) id m_extendInfoWithFromUsr; // @synthesize m_extendInfoWithFromUsr;
@property(retain, nonatomic) id m_extendInfoWithMsgType; // @synthesize m_extendInfoWithMsgType;
@property(retain, nonatomic) id m_extendInfoWithMsgTypeForBiz; // @synthesize m_extendInfoWithMsgTypeForBiz;
...
@property(nonatomic) unsigned long long macMsgSourceType; // @synthesize macMsgSourceType=_macMsgSourceType;
